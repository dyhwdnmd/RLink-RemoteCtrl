...
// Internal helpers shared by the ControllerMainWindow translation units.
...
inline constexpr auto kDefaultFileSaveDirectorySetting =
    "files/defaultSaveDirectory";

inline bool IsNineDigitPublicId(const QString& value)
{
...
inline QString LocalizedDirectSessionError(
...
inline bool IsDirectRecoveryFailureCode(const std::string& errorCode)
{
    return errorCode == "peer_reconnect_timeout" ||
           errorCode == "ice_restart_exhausted";
}
inline constexpr auto kVideoEncoderPreferenceSetting =
    "media/videoEncoderPreference";
inline constexpr auto kFfmpegX264PresetSetting =
    "media/ffmpegX264Preset";
inline constexpr auto kFfmpegHardwareBackendSetting =
    "media/ffmpegHardwareBackend";
inline constexpr auto kVideoDecoderPreferenceSetting =
    "media/videoDecoderPreference";
inline constexpr auto kVideoRendererPreferenceSetting =
    "media/videoRendererPreference";
inline constexpr auto kDesktopCaptureBackendSetting =
    "media/desktopCaptureBackend";
inline constexpr auto kScreenFrameRateLogEnabledSetting =
    "diagnostics/screenFrameRateCsvEnabled";
inline constexpr auto kInputEventStatsEnabledSetting =
    "diagnostics/inputEventStatsEnabled";
inline constexpr auto kBestDecoderNameSetting =
    "media/decoderProbe/bestDecoderName";
inline constexpr auto kBestDecoderAverageSetting =
    "media/decoderProbe/averageLatencyMs";
inline constexpr auto kBestDecoderP95Setting =
    "media/decoderProbe/p95LatencyMs";
inline constexpr auto kBestDecoderTestTimeSetting =
    "media/decoderProbe/testedAtUtc";
inline constexpr auto kDecoderCandidatesSetting =
    "media/decoderProbe/candidates";
inline constexpr auto kDecoderHardwareFingerprintSetting =
    "media/decoderProbe/hardwareFingerprint";
inline constexpr auto kDecoderBenchmarkCompletedSetting =
    "media/decoderProbe/completed";
inline constexpr auto kDecoderBenchmarkPassedSetting =
    "media/decoderProbe/passed";
inline constexpr auto kDecoderBenchmarkPolicyVersionSetting =
    "media/decoderProbe/policyVersion";
inline constexpr int kDecoderBenchmarkPolicyVersion =
    kVideoDecoderProbePolicyVersion;
inline constexpr auto kBestEncoderIdSetting =
    "media/encoderProbe/bestEncoderId";
inline constexpr auto kBestEncoderNameSetting =
    "media/encoderProbe/bestEncoderName";
inline constexpr auto kEncoderCandidatesSetting =
    "media/encoderProbe/candidates";
inline constexpr auto kEncoderHardwareFingerprintSetting =
    "media/encoderProbe/hardwareFingerprint";
inline constexpr auto kEncoderCaptureBackendSetting =
    "media/encoderProbe/captureBackend";
inline constexpr auto kEncoderX264PresetSetting =
    "media/encoderProbe/ffmpegX264Preset";
inline constexpr auto kEncoderBenchmarkCompletedSetting =
    "media/encoderProbe/completed";
inline constexpr auto kEncoderBenchmarkPassedSetting =
    "media/encoderProbe/passed";
inline constexpr auto kEncoderBenchmarkPolicyVersionSetting =
    "media/encoderProbe/policyVersion";
inline constexpr auto kBestEncoderTestTimeSetting =
    "media/encoderProbe/testedAtUtc";
inline constexpr int kEncoderBenchmarkPolicyVersion =
    kVideoEncoderProbePolicyVersion;
inline constexpr auto kCameraDeviceSetting =
    "media/cameraDeviceId";
inline constexpr auto kMicrophoneDeviceSetting =
    "media/microphoneDeviceId";
inline constexpr auto kSpeakerDeviceSetting =
    "media/speakerDeviceId";
inline constexpr auto kDefaultRoomCapacitySetting =
    "rooms/defaultCapacity";
inline constexpr auto kCloseButtonBehaviorSetting =
    "app/closeButtonBehavior";
inline constexpr auto kStartupVisibilitySetting =
    "app/startupVisibility";
inline constexpr auto kWindowsAutoStartValueName = "RemoteC";
inline constexpr auto kAutoOpenCameraGallerySetting =
    "media/autoOpenCameraGallery";
inline constexpr auto kInterfaceFontFamilySetting = "ui/systemFontFamily";

inline QStringList InstalledChineseInterfaceFonts()
{
...
inline void ApplyInterfaceFontPreference(const QString& systemFamily,
                                  int pixelSize)
{
    QFont font;
...
inline QString AdaptBenchmarkHtmlForTheme(QString html)
{
...
inline VideoEncoderPreference VideoEncoderPreferenceFromSetting(
    const QString& value)
{
...
inline DesktopCaptureImplementation DesktopCaptureImplementationFromSetting(
    const QString& value)
{
...
inline FfmpegHardwareBackend FfmpegHardwareBackendFromSetting(
    const QString& value)
{
...
inline FfmpegX264Preset EncoderQualityFromSetting(const QString& value)
{
...
inline VideoDecoderPreference VideoDecoderPreferenceFromSetting(
    const QString& value)
{
    if (value == QStringLiteral("hardware")) {
...
inline constexpr auto kRemotePasteEnabledSetting =
    "remoteSession/remotePasteEnabled";
inline constexpr auto kClipboardFormatsSetting =
    "remoteSession/clipboardFormats";
inline constexpr auto kClipboardFileLimitSetting =
    "remoteSession/clipboardFileLimitMiB";
inline constexpr auto kClipboardCacheBaseDirectorySetting =
    "transfer/remotePaste/cacheBaseDirectory";
inline constexpr auto kClipboardCacheRetentionSetting =
    "transfer/remotePaste/cacheRetentionMinutes";
inline constexpr auto kClipboardCacheCapacitySetting =
    "transfer/remotePaste/cacheLimitGiB";
inline constexpr std::uint64_t kRemotePastePopupThresholdBytes = 64ull * 1024ull;
inline constexpr int kSettingsControlWidth = 270;

inline QString InitialClipboardCacheBaseDirectory()
{
...
inline QString ClipboardCacheRootForBase(const QString& baseDirectory)
{
    return QDir::cleanPath(QDir(baseDirectory).filePath(
        QStringLiteral("RemoteC/ClipboardCache")));
}

inline qulonglong SafeClipboardCacheCapacityGiB(const QString& baseDirectory)
{
...
inline QString WindowsAutoStartCommand()
{
    return QStringLiteral("\"%1\"").arg(
        QDir::toNativeSeparators(QCoreApplication::applicationFilePath()));
}

inline bool WindowsAutoStartEnabled()
{
#ifdef Q_OS_WIN
    QSettings runKey(
        QStringLiteral(
...
inline bool SetWindowsAutoStartEnabled(bool enabled)
{
#ifdef Q_OS_WIN
    QSettings runKey(
        QStringLiteral(
...
inline std::pair<std::uint32_t, std::uint32_t> SavedScreenQualityBounds(
...
inline QString CsvCell(const std::string& value)
{
...
inline void AppendScreenFrameRateLog(
...
inline QString FormatBitrate(std::uint64_t bitsPerSecond)
{
...
inline QString FormatByteCount(std::uint64_t bytes)
{
...
inline QString SampleWindowSuffix(std::uint32_t windowMs)
{
    return windowMs > 0
...
inline QString LatestFrameTimingText(
...
inline QString RouteDisplayName(const std::string& route)
{
    if (route == "host") {
...
inline QString SlotDisplayName(const std::string& slot,
...
inline QString CandidateDisplayText(
...
inline QString DiagnosticsMetricExplanation(const QString& label)
{
...
inline QString DiagnosticsMetricToolTip(const DiagnosticsChip& chip)
{
...
inline QString InitialFileSaveDirectory()
{
...
inline QIcon CreateMediaStateIcon(MediaStateIcon type, bool active)
{
    QString iconName;
    switch (type) {
...
inline void SetMediaStateButton(QPushButton* button, MediaStateIcon type,
...
inline void SetCameraGalleryStateButton(QPushButton* button,
...
inline QToolButton* CreateMemberMediaIndicator(
...
inline QLabel* CreateRoomStatusIndicator(QWidget* parent, RoomStatusIcon type)
{
...
inline void SetBusyStatusAnimation(QLabel* label, bool busy)
{
    if (!label) {
        return;
    }
...
inline void AnimateSmallUiChange(QWidget* widget)
{
    const int level = CurrentUiAnimationLevel();
    if (!widget || level <= 0) {
        return;
...
inline constexpr auto kMainStyle = R"(
QMainWindow {
    background: #F5F4F0;
}
...
inline QPixmap DrawNavigationIcon(NavigationIcon icon, const QColor& color)
{
...
inline QIcon MakeNavigationIcon(NavigationIcon icon, bool dark)
{
    QIcon result;
...
inline QScrollArea* MakePageSurface(const QString& title,
...
inline QPushButton* MakeNavigationButton(const QString& text,
                                  NavigationIcon icon,
                                  bool active,
                                  QWidget* parent)
{
...
inline void AddRoomCapacityItems(QComboBox* comboBox)
{
...
inline QString MemberDisplayName(const RoomSnapshot& room,
...
inline QString ConnectivityDebugName(SessionConnectivityState state)
{
    switch (state) {
...
inline QString RoomMembershipDebugName(RoomMembershipState state)
{
    switch (state) {
...
inline QString PeerConnectionDebugName(RoomPeerConnectionState state)
{
    switch (state) {
...
inline QString MediaDeviceSelectionDebugName(
...
inline QString MediaDeviceDebugName(
...
inline QString MediaDeviceCategoryDebugText(
    const MediaDeviceCategorySnapshot& category)
{
